...
<body id="top">
    ...
    <section id='home' class="s-about">
        ...
        <div class="container" style="background-color: white; border-radius: 25px; margin-left: 6%; margin-right: 6%; margin-top: 20%;">
            <div> <h6 style="padding-left:5%; padding-top:3%; margin: 0%;"> License Number - <?php echo $license; ?> </h6> </div>             
            ...
            <p style=" margin-top:2%;  margin-bottom:0%">
                ...
                <p style="padding-top:0%; margin-top:0%; margin-bottom:2%;">
                  ...
                  <br>
                  <input style="border-radius: 5px ; background-color:green; color: white;" type="submit" name = "Update" value = "Update">
                </p>
          </form>   

                </h6> </div>
            <div> <h6 style="padding-left:5%; padding-top:2%; margin: 0%;">Duration - </h6> </div>   
            <div> <h6 style="padding-left:5%; padding-top:2%; margin: 0%;">Arrival Time - <?php echo $arrival; ?></h6> </div>   
            <div> <h6 style="padding-left:5%; padding-top:2%; margin: 0%;">Departure Time - <?php echo $depart; ?></h6> </div>    
            <div> <h6 style="padding-left:5%; padding-top:2%; padding-bottom:3%; margin: 0%;">Total Fee -  <?php echo $rate; ?></h6> </div>
        </div>
